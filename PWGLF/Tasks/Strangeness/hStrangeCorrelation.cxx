...
struct HStrangeCorrelation {
  ...
  THnF* hEfficiencyUncertaintyTriggerMultVsPhi;
  TH2F* hEfficiencyUncertaintyPion;
  TH2F* hEfficiencyUncertaintyK0Short;
  THnF* hEfficiencyUncertaintyK0ShortMultVsPhi;
  TH2F* hEfficiencyUncertaintyLambda;
  THnF* hEfficiencyUncertaintyLambdaMultVsPhi;
  TH2F* hEfficiencyUncertaintyAntiLambda;
  THnF* hEfficiencyUncertaintyAntiLambdaMultVsPhi;
  TH2F* hEfficiencyUncertaintyXiMinus;
  THnF* hEfficiencyUncertaintyXiMinusMultVsPhi;
  TH2F* hEfficiencyUncertaintyXiPlus;
  THnF* hEfficiencyUncertaintyXiPlusMultVsPhi;
  TH2F* hEfficiencyUncertaintyOmegaMinus;
  THnF* hEfficiencyUncertaintyOmegaMinusMultVsPhi;
  TH2F* hEfficiencyUncertaintyOmegaPlus;
  THnF* hEfficiencyUncertaintyOmegaPlusMultVsPhi;
  ...
  void initEfficiencyFromCCDB(aod::BCsWithTimestamps::iterator const& bc)
  {
    ...
    hEfficiencyUncertaintyTriggerMultVsPhi = static_cast<THnF*>(listEfficiencies->FindObject("hEfficiencyUncertaintyTriggerMultVsPhi"));
    hEfficiencyUncertaintyK0Short = static_cast<TH2F*>(listEfficiencies->FindObject("hEfficiencyUncertaintyK0Short"));
    hEfficiencyUncertaintyK0ShortMultVsPhi = static_cast<THnF*>(listEfficiencies->FindObject("hEfficiencyUncertaintyK0ShortMultVsPhi"));
    hEfficiencyUncertaintyLambda = static_cast<TH2F*>(listEfficiencies->FindObject("hEfficiencyUncertaintyLambda"));
    hEfficiencyUncertaintyLambdaMultVsPhi = static_cast<THnF*>(listEfficiencies->FindObject("hEfficiencyUncertaintyLambdaMultVsPhi"));
    hEfficiencyUncertaintyAntiLambda = static_cast<TH2F*>(listEfficiencies->FindObject("hEfficiencyUncertaintyAntiLambda"));
    hEfficiencyUncertaintyAntiLambdaMultVsPhi = static_cast<THnF*>(listEfficiencies->FindObject("hEfficiencyUncertaintyAntiLambdaMultVsPhi"));
    hEfficiencyUncertaintyXiMinus = static_cast<TH2F*>(listEfficiencies->FindObject("hEfficiencyUncertaintyXiMinus"));
    hEfficiencyUncertaintyXiMinusMultVsPhi = static_cast<THnF*>(listEfficiencies->FindObject("hEfficiencyUncertaintyXiMinusMultVsPhi"));
    hEfficiencyUncertaintyXiPlus = static_cast<TH2F*>(listEfficiencies->FindObject("hEfficiencyUncertaintyXiPlus"));
    hEfficiencyUncertaintyXiPlusMultVsPhi = static_cast<THnF*>(listEfficiencies->FindObject("hEfficiencyUncertaintyXiPlusMultVsPhi"));
    hEfficiencyUncertaintyOmegaMinus = static_cast<TH2F*>(listEfficiencies->FindObject("hEfficiencyUncertaintyOmegaMinus"));
    hEfficiencyUncertaintyOmegaMinusMultVsPhi = static_cast<THnF*>(listEfficiencies->FindObject("hEfficiencyUncertaintyOmegaMinusMultVsPhi"));
    hEfficiencyUncertaintyOmegaPlus = static_cast<TH2F*>(listEfficiencies->FindObject("hEfficiencyUncertaintyOmegaPlus"));
    hEfficiencyUncertaintyOmegaPlusMultVsPhi = static_cast<THnF*>(listEfficiencies->FindObject("hEfficiencyUncertaintyOmegaPlusMultVsPhi"));
  ...
  void fillCorrelationsV0(aod::TriggerTracks const& triggers, aod::AssocV0s const& assocs, bool mixing, bool mixingInBf, float pvx, float pvy, float pvz, float mult, double bField)
  {
    ...
    for (auto const& triggerTrack : triggers) {
      ...
      if (efficiencyFlags.applyEfficiencyForTrigger) {
        if (!efficiencyFlags.applyEffAsFunctionOfMultAndPhi) {
          ...
          if (efficiencyFlags.applyEfficiencyPropagation) {
            efficiencyTriggError = hEfficiencyUncertaintyTriggerMultVsPhi->GetBinContent(hEfficiencyUncertaintyTriggerMultVsPhi->GetBin(bintrig));
          }
        }
      ...
      for (auto const& assocCandidate : assocs) {
        ...
        THnF* hEfficiencyUncertaintyV0MultVsPhi[3];
        if (efficiencyFlags.applyEffAsFunctionOfMultAndPhi) {
          ...
          hEfficiencyUncertaintyV0MultVsPhi[0] = hEfficiencyUncertaintyK0ShortMultVsPhi;
          hEfficiencyUncertaintyV0MultVsPhi[1] = hEfficiencyUncertaintyLambdaMultVsPhi;
          hEfficiencyUncertaintyV0MultVsPhi[2] = hEfficiencyUncertaintyAntiLambdaMultVsPhi;
        } else {
        ...
        static_for<0, 2>([&](auto i) {
          ...
          if (efficiencyFlags.applyEfficiencyCorrection) {
            if (efficiencyFlags.applyEffAsFunctionOfMultAndPhi) {
              ...
              if (efficiencyFlags.applyEfficiencyPropagation)
                efficiencyError = hEfficiencyUncertaintyV0MultVsPhi[Index]->GetBinContent(hEfficiencyUncertaintyV0MultVsPhi[Index]->GetBin(bin));
            } else {
              if (efficiencyFlags.applyEffAsFunctionOfMultAndPhi) {
    ...
    int hastirgorassoc = masterConfigurations.collisionHasTrigOrAssoc.value;
    ...
    for (const auto& collision : validCollisions[binnumb]) {
      ...
      // When 'collisionHasTrigOrAssoc' = 0:
      // binContent(hMECollisionBins) = Σ(run=1 to numberOfRuns)[binContent(the same bin of hSECollisionBins) * masterConfigurations.mixingParameter - Σ(k=0 to min(masterConfigurations.mixingParameter,binContent)) k]
      // When 'collisionHasTrigOrAssoc' = 3
      // More collision loss at higher peripheral centrality (fewer target particles); higher bin content of HIST("mixedEvent/Signal/") + HIST(Cascadenames[Index])
  ...
  void fillCorrelationsCascade(aod::TriggerTracks const& triggers, aod::AssocCascades const& assocs, bool mixing, bool mixingInBf, float pvx, float pvy, float pvz, float mult, double bField)
  {
    ...
    for (auto const& triggerTrack : triggers) {
      ...
      for (auto const& assocCandidate : assocs) {
        ...
        THnF* hEfficiencyUncertaintyCascadeMultVsPhi[4];
        if (efficiencyFlags.applyEffAsFunctionOfMultAndPhi) {
          hEfficiencyUncertaintyCascadeMultVsPhi[0] = hEfficiencyUncertaintyXiMinusMultVsPhi;
          hEfficiencyUncertaintyCascadeMultVsPhi[1] = hEfficiencyUncertaintyXiPlusMultVsPhi;
          hEfficiencyUncertaintyCascadeMultVsPhi[2] = hEfficiencyUncertaintyOmegaMinusMultVsPhi;
          hEfficiencyUncertaintyCascadeMultVsPhi[3] = hEfficiencyUncertaintyOmegaPlusMultVsPhi;
        } else {
        ...
        static_for<0, 3>([&](auto i) {
          ...
          if (efficiencyFlags.applyEfficiencyCorrection) {
            if (efficiencyFlags.applyEffAsFunctionOfMultAndPhi) {
              ...
              if (efficiencyFlags.applyEfficiencyPropagation)
                efficiencyError = hEfficiencyUncertaintyCascadeMultVsPhi[Index]->GetBinContent(hEfficiencyUncertaintyCascadeMultVsPhi[Index]->GetBin(bin));
            } else {
  ...
  void init(InitContext const&)
  {
    ...
    // v--- masterConfigurations.skipUnderOverflowInTHn ---v
    //
